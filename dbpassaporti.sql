...
--
-- Host: 127.0.0.1
-- Creato il: Mag 20, 2023 alle 17:29
...
CREATE TABLE `cittadini` (
  `idCittadino` int(11) NOT NULL,
  `codiceFiscaleCittadino` char(16) NOT NULL,
...
INSERT INTO `cittadini` (`idCittadino`, `codiceFiscaleCittadino`, `password`, `nome`, `cognome`, `dataNascita`, `luogoNascita`) VALUES
(8, 'CNTCRL61C13D612C', '12', 'CARLO', 'CONTI', '1961-03-13', 'FIRENZE');
...
ALTER TABLE `cittadini`
  ...
  ADD UNIQUE KEY `codiceFiscaleCittadino` (`codiceFiscaleCittadino`);
...
--
ALTER TABLE `cittadini`
  MODIFY `idCittadino` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `cittadini`
  ADD CONSTRAINT `codiceFiscaleCittadino` FOREIGN KEY (`codiceFiscaleCittadino`) REFERENCES `anagrafiche` (`codiceFiscale`);
